...
<nav>
    <div class="nav-wrapper">
        ...
        <ul id="nav-mobile" class="left hide-on-med-and-down">
            ...
            <li><a href="${ctx}/createPost">Create Post</a></li>
            <li><a href="${ctx}/signIn">LogOut</a></li>
        </ul>
    </div>
</nav>
<br>
<form action="${ctx}/findpost" class="row" method="post">
        ...
        <c:forEach begin="1" end="${numberOfPages}" var="i">
            <c:choose>
                <c:when test="${currentPage eq i}">
                    <li class="active"><a href="${ctx}/myposts?page=${currentPage}">${currentPage}</a></li>
                </c:when>
                <c:otherwise>
                    <li class="waves-effect"><a href="${ctx}/myposts?page=${i}">${i}</a></li>
                </c:otherwise>
            </c:choose>
        </c:forEach>
    </ul>
